...
export declare class LightVM {
    ...
    setMaxIo: (val: number) => this;
    setMaxImport: (val: number) => this;
    setMaxAlloc: (val: number) => this;
    setMaxCall: (val: number) => this;
    setMaxJump: (val: number) => this;
    ...
    withDiagnosticLinks: (en: boolean) => this;
    info(): string;
