...
This error occurs when the parser or executor encounters an illegal instruction.

## Runtime message

The runtime message reports the unrecognized instruction in `code` and the instruction pointer where it was encountered.
