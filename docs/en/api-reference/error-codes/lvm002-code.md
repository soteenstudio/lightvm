...
This error occurs when an instruction attempts to pop a value from an empty stack.

## Runtime message

The runtime message identifies the instruction with `opcode` and reports the instruction pointer where it failed.
