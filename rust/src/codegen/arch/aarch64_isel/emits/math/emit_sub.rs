...
#[inline]
pub fn emit_sub(builder: AArch64Builder, num_type: &PrimitiveTypes) -> AArch64Builder {
  ...
  let comment_str = format!("Sub({:?})", num_type);
