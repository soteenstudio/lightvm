  ...
  let execution_result = (|| -> Result<(Value, u64), VMError> {
    while ip < bytecode_len {
      ...
      match instr {
        ...
        | Instructions::Powf(_)
        | Instructions::Powv(_)
        | Instructions::Powiv(_)
        | Instructions::Powfv(_)
        | Instructions::Sin(_)
        | Instructions::Cos(_)
        | Instructions::Tan(_)
        | Instructions::Sinv(_)
        ...
        | Instructions::Asinv(_)
        | Instructions::Acosv(_)
        | Instructions::Atanv(_)
        | Instructions::Atan2v(_)
        | Instructions::Sinh(_)
        | Instructions::Cosh(_)
        | Instructions::Tanh(_)
        | Instructions::Sinhv(_)
        | Instructions::Coshv(_)
        | Instructions::Tanhv(_)
        | Instructions::Asinh(_)
        | Instructions::Acosh(_)
        | Instructions::Atanh(_)
        | Instructions::Asinhv(_)
        | Instructions::Acoshv(_)
        | Instructions::Atanhv(_)
        | Instructions::Sqrt(_)
        | Instructions::Sqrtv(_)
        | Instructions::Cbrt(_)
        | Instructions::Cbrtv(_)
        | Instructions::Neg(_)
        | Instructions::Negv(_)
        | Instructions::Ln(_)
        | Instructions::Lnv(_)
        ...
        | Instructions::Expv(_)
        | Instructions::Log2(_)
        | Instructions::Log2v(_)
        | Instructions::Log10(_)
        | Instructions::Log10v(_)
        | Instructions::Dot(_)
