...
pub fn math_dispatch(
  ...
  match instr {
    ...
    Instructions::Shlv(num_type) => shlv_func(stack, *num_type, ip),
    Instructions::Shr(num_type) => shr_func(stack, *num_type, ip),
    Instructions::Shrv(num_type) => shrv_func(stack, *num_type, ip),
    Instructions::Ror(num_type) => ror_func(stack, *num_type, ip),
    Instructions::Rorv(num_type) => rorv_func(stack, *num_type, ip),
    Instructions::Rol(num_type) => rol_func(stack, *num_type, ip),
    Instructions::Rolv(num_type) => rolv_func(stack, *num_type, ip),
    ...
    Instructions::Sqrtv(num_type) => sqrtv_func(stack, *num_type, ip),
    Instructions::Cbrt(num_type) => cbrt_func(stack, *num_type, ip),
    Instructions::Cbrtv(num_type) => cbrtv_func(stack, *num_type, ip),
    ...
    Instructions::Lnv(num_type) => lnv_func(stack, *num_type, ip),
    Instructions::Exp(num_type) => exp_func(stack, *num_type, ip),
    Instructions::Expv(num_type) => expv_func(stack, *num_type, ip),
    Instructions::Log2(num_type) => log2_func(stack, *num_type, ip),
    Instructions::Log2v(num_type) => log2v_func(stack, *num_type, ip),
