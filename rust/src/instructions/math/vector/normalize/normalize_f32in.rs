...
use std::sync::Arc;
pub fn normalize_f32in(values: &[Value], magnitude: f32) -> Value {
  Value::Array(Arc::new(
    values
      .iter()
      .map(|value| {
