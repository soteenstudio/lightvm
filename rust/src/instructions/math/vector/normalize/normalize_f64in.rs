...
use std::sync::Arc;
pub fn normalize_f64in(values: &[Value], magnitude: f64) -> Value {
  Value::Array(Arc::new(
    values
      .iter()
      .map(|value| {
